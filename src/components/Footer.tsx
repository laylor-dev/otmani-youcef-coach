      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="md:col-span-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://www.linkedin.com/in/youcef-otmani-7b3807356/"
              target="_blank"
              rel="noreferrer"
              aria-label="LinkedIn"
              className="w-10 h-10 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center text-neutral-500 transition-all font-primary"
              onMouseOver={(e) => {
                e.currentTarget.style.backgroundColor = accentColor;
                e.currentTarget.style.borderColor = accentColor;
                e.currentTarget.style.color = "white";
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="text-sm text-neutral-500 space-y-2 font-primary tracking-wider">
                <div className="relative group/mail flex items-center gap-2">
                  <a 
                    href="mailto:youcef.otmani.pt@gmail.com" 
                    className="hover:text-white transition-colors block uppercase"
                  >
                    youcef.otmani.pt@gmail.com
                  </a>
                  <button 
                    onClick={copyEmail}
